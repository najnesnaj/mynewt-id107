...
*/
/*****************************************************************************/
#ifndef __SI1143_PRIV_H__
#define __SI1143_PRIV_H__
...
int si1143_write8(struct sensor_itf *itf, uint8_t reg, uint32_t value);
int si1143_write16(struct sensor_itf *itf, uint8_t reg, uint16_t value);
int si1143_read8(struct sensor_itf *itf, uint8_t reg, uint8_t *value);
int si1143_read16(struct sensor_itf *itf, uint8_t reg, uint16_t *value);
